                    ...
                    <div className={styles.chatContainer}>
                        {!lastQuestionRef.current ? (
                            <div className={styles.chatEmptyState}>
                                ...
                                <h1 className={styles.chatEmptyStateTitle}>Chat with ALG Gen AI</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Ask anything about ALG Worldwide Logistics</h2>
                        ...
                        <div className={styles.chatInput}>
                            <QuestionInput
                                clearOnSend
                                placeholder="Type a new question (e.g. How does ALG Facilitate packing and drop off services?)"
                                disabled={isLoading}
